...
class image1d_array_t(imagend_t):
    ...
    def _update_format(self)->None:
        ...
        self._desc:cl_image_desc = cl_image_desc(cl_mem_object_type.CL_MEM_OBJECT_IMAGE1D_ARRAY, self._shape[1], 0, 0, self._shape[0], 0, 0, 0, 0)
