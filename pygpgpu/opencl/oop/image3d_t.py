...
class image3d_t(imagend_t):
    ...
    def _update_format(self)->None:
        ...
        self._desc:cl_image_desc = cl_image_desc(cl_mem_object_type.CL_MEM_OBJECT_IMAGE3D, self._shape[2], self._shape[1], self._shape[0], 0, 0, 0, 0, 0)
