...
class image1d_t(imagend_t):
    ...
    def _update_format(self)->None:
        if len(self._shape) == 1:
            ...
            self._channel_order = self._get_channel_order(self._shape[1])
        else:
        ...
        self._desc:cl_image_desc = cl_image_desc(cl_mem_object_type.CL_MEM_OBJECT_IMAGE1D, self._shape[0], 0, 0, 0, 0, 0, 0, 0)
