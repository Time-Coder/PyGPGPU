...
class Kernel_test(KernelWrapper):
    ...
    @override
    def __call__(self, a: NDArray[np.int32], length: int)->None: ...

    @override
    def submit(self, a: NDArray[np.int32], length: int)->concurrent.futures.Future: ...
    
    @override
    def async_call(self, a: NDArray[np.int32], length: int)->asyncio.Future: ...
